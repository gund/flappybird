...
"%":"ArrayBuffer|Blob|CanvasGradient|CanvasPattern|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedNumberList"},
kn:{
"^":"bool/Gv;",
...
z.VO(a,b)
return z}}}}],["browser_detect","file:///Users/alex/dart/flappybird/web/browser_detect.dart",,F,{
"^":"",
EJ:function(){return H.Sz($.yA(),new F.UE(),new F.C5())},
uy:function(a){var z=window.navigator.vendor
return z!=null&&J.x5(z,a)},
oO:{
"^":"a;oc,Ir,dK",
gTz:function(){return this===$.pg()},
W0:function(){return this.Ir.call$0()},
TC:function(){return this.dK.call$0()},
bu:function(a){return C.xB.bS(this.oc+" "+H.d(new F.pI(this.TC(),null)))}},
KG:{
"^":"oO;oc,Ir,dK",
static:{Kb:function(){return new F.KG("Unknown Browser",new F.ix(),new F.qd())}}},
ix:{
"^":"Tp:10;",
...
UE:{
"^":"Tp:12;",
call$1:function(a){return a.W0()}},
C5:{
"^":"Tp:10;",
call$0:function(){return $.bp()}},
Md:{
"^":"Tp:10;",
call$0:function(){return F.uy("Google")}},
YJ:{
"^":"Tp:10;",
...
wJ:{
"^":"Tp:10;",
call$0:function(){return F.uy("Apple")}},
W6:{
"^":"Tp:10;",
...
DO:{
"^":"Tp:10;",
call$0:function(){return F.uy("Opera")}},
lP:{
"^":"Tp:10;",
...
Uf:{
"^":"Tp:10;",
call$0:function(){return J.x5(window.navigator.appName,"Microsoft")}},
Ra:{
"^":"Tp:10;",
...
wJY:{
"^":"Tp:10;",
call$0:function(){return J.x5(window.navigator.userAgent,"Firefox")}},
zOQ:{
"^":"Tp:10;",
...
if(z==null){z=new H.A8(J.uH(this.P,"."),new F.NG())
z.$builtinTypeInfo=[null,null]
this.i2=z}return z},
iM:function(a,b){var z,y,x,w,v
for(z=J.RE(b),y=0;y<P.y(J.q8(this.gP9(this).CR),J.q8(z.gP9(b)));++y){if(y<J.q8(this.gP9(this).CR)){x=this.gP9(this)
w=x.mb(J.i4(x.CR,y))}else w=0
v=J.oE(w,y<J.q8(z.gP9(b))?J.i4(z.gP9(b),y):0)
if(v!==0)return v}return 0},
D:function(a,b){var z
if(typeof b==="string")b=new F.pI(b,null)
z=J.x(b)
return typeof b==="object"&&b!==null&&!!z.$ispI&&this.iM(0,b)>0},
...
NG:{
"^":"Tp:12;",
call$1:function(a){return H.BU(a,null,new F.BV())}},
BV:{
"^":"Tp:12;",
call$1:function(a){return 0}}}],["dart._internal","dart:_internal",,H,{
"^":"",
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"QC","call$2","call$1","giO",2,2,14,9],
...
xd:{
"^":"YB;m6,Q6,zx,MU,vv,OX,OB,H9,lX,zN",
...
$isiP:true,
static:{"^":"Oj,Vp,Ej,yz,ch,QC,Px,Yp,kc,Gi,k3,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
return z}}},
Hn:{
"^":"Tp:19;",
...
$isa6:true,
static:{"^":"Wt,CR,dk,uU,zj,b2,q9,Ie,Do,Cv,kT,IJ,D9,Vk,S8,rG",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:19;",
...
Gc:{
"^":"Y5;ku:fillStyle},EJ:font},Mp:imageSmoothingEnabled}",
...
uw:function(a,b,c,d,e){a.fillStyle="rgba("+H.d(b)+", "+H.d(c)+", "+H.d(d)+", "+H.d(e)+")"},
...
"%":"DataView;ArrayBufferView;LZ|Ob|GV|XU|fj|Ip|Pg"},
Hg:{
"^":"XU;",
...
if(b>>>0!=b||J.FK(b,z))this.J2(a,b,z)
a[b]=c},
$isList:true,
...
return}throw "Unable to print message: " + String(a)}}],["flappy_bird","file:///Users/alex/dart/flappybird/web/flappy_bird.dart",,M,{
"^":"",
Iq:[function(){$.lB=M.Or(M.WH())},"call$0","eE",0,0,1],
...
y=J.xH($.Jh,$.eI)
z=J.Wx(y)
y=J.p0(z.D(y,450)?z.U(y,2):y,0.5)
if(J.xZ(y,700))y=700
if($.Es){z=$.vW()
if(typeof y!=="number")return H.s(y)
if(typeof z!=="number")return z.g()
z+=0.012*y
$.HE=z}else{if(J.xZ(y,70))y=50
z=$.vW()
if(typeof y!=="number")return H.s(y)
if(typeof z!=="number")return z.W()
z-=0.12*y
$.HE=z}if(z+34<-68){$.HE=-34
$.Es=!0
$.eI=$.Jh
z=-34}x=$.bK
...
J.Dg($.Ee)
J.HS($.Ee,v,z)
J.Ta($.Ee,$.iD*3.141592653589793/180)
J.W1($.Ee,$.LQ().t(0,$.tS+$.ln),-17,-12)
u=$.Ee
...
J.Dg($.Ee)
z=$.Ee
J.RE(z).sEJ(z,"60px Arial")
z.fillStyle="#000000"
v=s+2
u=r+2
C.Tr.lR(z,C.jn.bu($.JH),v,u)
z=s-2
x=r-2
J.mi($.Ee,C.jn.bu($.JH),z,x)
J.mi($.Ee,C.jn.bu($.JH),v,x)
J.mi($.Ee,C.jn.bu($.JH),z,u)
u=$.Ee
J.RE(u).sku(u,"#ffffff")
C.Tr.lR(u,C.jn.bu($.JH),s,r)
J.Mq($.Ee)
z=$.oe
if(z>0||$.a4){x=$.Ee
w=$.KZ()
J.oj(x,w[0],w[1],w[2],z)
J.HM($.Ee,0,0,$.ES,$.bK)
if($.yJ){z=$.oe
x=$.KZ()[3]
if(z<1-x)$.oe=z+x
...
u=r+80
if(!$.Ly){q=$.VX
C.Tr.lR(x,q,z+2*q.length,r-20)
q=$.Ee
J.RE(q).sEJ(q,"30px Arial")
C.Tr.lR(q,"Space or Click to fly!",z+44+25,r+40)
q=$.Ee
J.RE(q).sEJ(q,"20px Arial")
C.Tr.lR(q,"Change dufficulty: [0-4]",v,u)}else{C.Tr.lR(x,"Score: "+$.JH,z+100-7*C.jn.bu($.JH).length-1,r-40)
x=$.Ee
J.RE(x).sEJ(x,"40px Arial")
C.Tr.lR(x,"Difficulty: "+$.VX,v,r+30)
v=$.Ee
J.RE(v).sEJ(v,"30px Arial")
C.Tr.lR(v,"Space or Click to start again!",z+10,u)}J.I2($.Ee,z,w,400,200)
J.Mq($.Ee)}J.Eu($.Me,0,0,$.ES,$.bK)
J.W1($.Me,$.Y4,0,0)},"call$1","ri",2,0,6],
...
w=z+10
v=z-10
for(u=!1,t=!1,s=0;z=$.wU(),s<z.MU;++s){r=J.xH(J.UQ(z.Zv(0,s),"center"),26)
q=J.WB(J.UQ($.wU().Zv(0,s),"center"),26)
p=J.xZ(J.UQ($.wU().Zv(0,s),"top"),y)||J.u6(J.WB(J.UQ($.wU().Zv(0,s),"top"),110),x)
if(!t&&J.u6(r,w)&&J.xZ(q,v)&&p){M.fL()
t=!0}if(!u&&J.UQ($.wU().Zv(0,s),"checked")!==!0)if(J.u6(J.UQ($.wU().Zv(0,s),"center"),$.wY())){$.lB.uP(0,"point")
J.kW($.wU().Zv(0,s),"checked",!0)
$.JH=$.JH+1
u=!0}if(t&&u)break}},
ic:function(){var z,y,x
for(z=0;y=$.wU(),z<y.MU;++z){y=y.Zv(0,z)
x=J.U6(y)
x.u(y,"center",J.xH(x.t(y,"center"),3))}},
j5:function(a){var z,y,x,w
if(!$.Ly&&J.xZ(J.xH(a,$.Ec),8250)){for(z=0,y=0;x=$.wU(),y<x.MU;++y)if(J.u6(J.WB(J.UQ(x.Zv(0,y),"center"),52),0)){x=$.wU()
x.Rz(0,x.Zv(0,y));++z;--y}x=$.bK
if(typeof x!=="number")return x.U()
w=x-x*0.2-110-50
for(y=0;y<z;++y)M.Cc($.wU().MU,w)
P.JS("Deleted pipes: "+z)
P.JS("Generated pipes: "+y)
$.Ec=a}},
...
if(typeof x!=="number")return H.s(x)
if(y<x&&z&&$.iD<90){z=$.iD+4
$.iD=z
$.YF=!1
if(z>90)$.iD=90}if(!$.YF&&$.iD<0)$.iD=$.iD+8
z=$.iD
if(z<=-60)$.YF=!1
if(z>10){$.ln=2
return}if(J.xZ(J.xH($.Jh,$.XF),75)){$.XF=$.Jh
z=$.ln+1
$.ln=z
if(z===3)$.ln=0}},
qB:function(){var z,y,x,w,v,u
for(z=0;y=$.wU(),z<y.MU;++z){if(J.xZ(J.WB(J.UQ(y.Zv(0,z),"center"),52),0)&&J.u6(J.xH(J.UQ($.wU().Zv(0,z),"center"),52),$.ES)){y=J.UQ($.wU().Zv(0,z),"center")
x=J.UQ($.wU().Zv(0,z),"top")
w=J.xH(y,26)
J.Dg($.Ee)
y=$.Ee
J.yc(y,"#00ff00")
v=J.Wx(x)
y.drawImage($.LQ().t(0,$.La+"Top"),w,v.W(x,320))
if(J.xZ(v.W(x,320),0))J.W1($.Ee,$.LQ().t(0,$.La+"Filler"),w,J.xH(v.W(x,180),$.bK))
J.W1($.Ee,$.LQ().t(0,$.La+"Bottom"),w,v.g(x,110))
y=J.WB(v.g(x,110),320)
u=$.bK
if(typeof u!=="number")return u.U()
if(J.u6(y,u-u*0.2))J.W1($.Ee,$.LQ().t(0,$.La+"Filler"),w,J.WB(v.g(x,110),320))
J.Mq($.Ee)}if(J.xZ(J.xH(J.UQ($.wU().Zv(0,z),"center"),52),$.ES))break}},
kE:[function(){var z,y
z=J.Vg(document.querySelector("#fullscreen"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(M.An()),z.Sg),[H.Kp(z,0)]).Zz()
z=document.querySelector("#render_area")
$.EL=z
$.Me=J.PB(z,"2d")
z=W.d9(null,null)
$.Y4=z
...
$.qy=z
y=$.Me
if(y==null||$.Ee==null||z==null)H.vh(P.FM("Failed to get 2D context!"))
J.ob(y,!0)
J.ob($.Ee,!0)
J.ob($.qy,!0)
M.a7(null)
...
M.jo()
z=J.wK($.vM())
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(M.RB()),z.Sg),[H.Kp(z,0)]).Zz()
z=H.VM(new W.RO(window,C.fW.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(M.ex()),z.Sg),[H.Kp(z,0)]).Zz()
z=$.AM()
P.JS("Browser is: "+H.d(z))
if(!z.gTz()){y=$.X9()
if(z==null?y!=null:z!==y){y=$.Au()
if(z==null?y!=null:z!==y){y=$.p8()
if(z==null?y!=null:z!==y){y=$.MJ()
y=z==null?y==null:z===y
z=y}else z=!0}else z=!0}else z=!0}else z=!0
y=$.EL
if(z){z=J.Vg(y)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(M.ex()),z.Sg),[H.Kp(z,0)]).Zz()}else{y.toString
z=H.VM(new W.Cq(y,C.BD.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(M.Lh()),z.Sg),[H.Kp(z,0)]).Zz()}z=H.VM(new W.RO(window,C.IU.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(M.Zn()),z.Sg),[H.Kp(z,0)]).Zz()
M.Rn(20)
M.Hw(0)},"call$0","WH",0,0,1],
nx:[function(a){$.EL.webkitRequestFullscreen()},"call$1","An",2,0,7],
OQ:function(){$.LQ().to("backgroundDay",new M.SI())
$.LQ().to("backgroundNight",new M.GX())
$.LQ().to("ground",new M.eh())
$.LQ().to("birdYellow0",new M.Q3())
$.LQ().to("birdYellow1",new M.kg())
$.LQ().to("birdYellow2",new M.Ua())
$.LQ().to("birdBlue0",new M.SIM())
$.LQ().to("birdBlue1",new M.Rnx())
$.LQ().to("birdBlue2",new M.vLV())
$.LQ().to("birdRed0",new M.GXg())
$.LQ().to("birdRed1",new M.eh2())
$.LQ().to("birdRed2",new M.LsI())
$.LQ().to("pipeGreenTop",new M.Q3e())
$.LQ().to("pipeGreenBottom",new M.uRa())
$.LQ().to("pipeGreenFiller",new M.kga())
$.LQ().to("pipeRedTop",new M.Uaa())
$.LQ().to("pipeRedBottom",new M.S0())
$.LQ().to("pipeRedFiller",new M.S1())},
AO:[function(a){var z
P.JS("Textures chached!")
z=$.LQ()
if(z.MU>0){z.lX=null
z.H9=null
z.OB=null
...
z.vv=null
z.MU=0
z.zN=z.zN+1&67108863}z.to("backgroundDay",new M.pu())
$.LQ().to("backgroundNight",new M.c4())
$.LQ().to("ground",new M.ai())
$.LQ().to("birdYellow0",new M.o2())
$.LQ().to("birdYellow1",new M.Nh())
$.LQ().to("birdYellow2",new M.BK())
$.LQ().to("birdBlue0",new M.cA())
$.LQ().to("birdBlue1",new M.Ld())
$.LQ().to("birdBlue2",new M.Ba())
$.LQ().to("birdRed0",new M.puw())
$.LQ().to("birdRed1",new M.c4u())
$.LQ().to("birdRed2",new M.ai4())
$.LQ().to("pipeGreenTop",new M.o2q())
$.LQ().to("pipeGreenBottom",new M.Nhu())
$.LQ().to("pipeGreenFiller",new M.BKu())
$.LQ().to("pipeRedTop",new M.cAa())
$.LQ().to("pipeRedBottom",new M.Lda())
$.LQ().to("pipeRedFiller",new M.Baa())
M.jo()},function(){return M.AO(null)},null,"call$1","call$0","RB",0,2,8,9],
cn:function(a,b,c,d,e,f,g){var z,y,x,w
z=W.d9(null,null)
y=J.PB(z,"2d")
if(y==null)throw H.b(P.FM("Failed to get 2D context for texture buffer!"))
J.ob(y,!0)
x=e!=null
z.width=x?f:c
z.height=x?g:d
...
w.sfg(x,d)
J.Eu($.qy,0,0,c,d)
J.QY($.qy,$.vM(),a,b,c,d,0,0,c,d)
y.rect(0,0,f,g)
y.fillStyle=y.createPattern($.pM,e)
y.fill()}else y.drawImage($.vM(),a,b,c,d,0,0,c,d)
return z},
...
x.sfg(y,w)
$.Ma=z*1/4
P.JS("Render size: "+H.d($.ES)+"x"+H.d($.bK))
z=$.ES
w=$.bK
$.LQ().u(0,"backgroundDay",M.cn(0,0,288,512,"repeat-x",z,512))
$.LQ().u(0,"backgroundNight",M.cn(292,0,288,512,"repeat-x",z,512))
y=$.LQ()
if(typeof z!=="number")return z.g()
y.u(0,"ground",M.cn(584,0,336,112,"repeat-x",z+336,112))
$.LQ().u(0,"pipeGreenFiller",M.cn(112,646,52,294,"repeat-y",52,w))
$.LQ().u(0,"pipeRedFiller",M.cn(0,646,52,294,"repeat-y",52,w))},function(){return M.a7(null)},null,"call$1","call$0","Zn",0,2,8,9],
I4:[function(a){var z,y
z=J.RE(a)
z.e6(a)
y=a.type
if(y==="click")if(($.J6&3)===3)M.j1()
else{if($.Ly&&J.u6(J.xH($.Jh,$.Yu),500)||$.yJ)return
if(($.J6&1)===1)M.Ac()
else M.yN()}else if(y==="keypress")switch(z.gHQ(a)){case 32:if(($.J6&3)===3)M.j1()
else{if($.Ly&&J.u6(J.xH($.Jh,$.Yu),500)||$.yJ)return
if(($.J6&1)===1)M.Ac()
else M.yN()}break
case 27:break
...
case 52:M.WJ(4)
break
default:}},"call$1","ex",2,0,7],
yN:function(){$.J6=($.J6|3)>>>0
M.j1()},
j1:function(){$.lB.uP(0,"wing")
$.Es=!1
$.kf=$.vW()
$.eI=$.Jh},
Rn:function(a){var z,y,x
if(a<1)throw H.b(P.FM("Invalid argument!"))
z=$.wU()
if(z!=null)if(z.MU>0){z.lX=null
z.H9=null
z.OB=null
z.OX=null
z.vv=null
z.MU=0
z.zN=z.zN+1&67108863}z=$.bK
if(typeof z!=="number")return z.U()
y=z-z*0.2-110-50
for(x=0;x<a;++x)M.Cc(x,y)},
Cc:function(a,b){var z,y,x,w,v,u
z={}
z.a=null
z.b=null
y=P.L5(null,null,null,J.O,null)
y.to("checked",new M.fR())
if(a===0){y.to("center",new M.ap(a))
z.a=50+$.YG().j1(C.CD.yu(b)-50)}else{x=a-1
z.b=J.UQ($.wU().Zv(0,x),"center")
y.to("center",new M.pY(z))
w=J.UQ($.wU().Zv(0,x),"top")
x=J.Wx(w)
v=J.Oq(x.W(w,$.zz()))
u=J.Oq(x.g(w,$.zz()))
if(v<50)v=50
if(u+110>b)u=b
x=C.CD.yu(v)
z.a=x+$.YG().j1(C.CD.yu(u)-x)}y.to("top",new M.jh(z))
$.wU().h(0,y)},
jo:function(){$.J5=0+$.YG().j1(C.jn.yu(2)-0)===0?"backgroundDay":"backgroundNight"
$.La=0+$.YG().j1(C.jn.yu(2)-0)===0?"pipeGreen":"pipeRed"
switch(0+$.YG().j1(C.jn.yu(3)-0)){case 0:$.tS="birdYellow"
break
case 1:$.tS="birdBlue"
break
case 2:$.tS="birdRed"
break
default:}$.wX=J.Qd(J.bL(J.PB($.LQ().t(0,$.J5),"2d"),0,0,1,1))},
Ac:function(){$.a4=!0
$.yJ=!0
$.oe=0
$.xD=[0,0,0,0.02]},
fL:function(){$.lB.R8(0,"hit","die")
$.J6=($.J6&4294967289)>>>0
$.Ly=!0
$.Yu=$.Jh
$.VX=C.jn.bu($.ao)
...
$.iD=0
M.Rn(20)}},
WA:[function(a){J.fD(a)
M.j1()
$.jl=!0},"call$1","Lh",2,0,7],
Of:{
"^":"a;UY,Br,ic,aW,DB",
h9:function(){return this.aW.call$0()},
yv:function(){C.jP.aN(0,new M.Xp(this))},
vj:function(a,b){var z,y
z=new XMLHttpRequest()
C.W3.eo(z,"GET",b,!0)
z.responseType="arraybuffer"
y=H.VM(new W.RO(z,C.LF.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new M.Wg(this,a,z)),y.Sg),[H.Kp(y,0)]).Zz()
y=H.VM(new W.RO(z,C.MD.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new M.DB()),y.Sg),[H.Kp(y,0)]).Zz()
z.send()},
R8:function(a,b,c){var z=$.of()
z.toString
if(H.VM(new P.i5(z),[H.Kp(z,0)]).Fb.x4(b)){z=this.UY.createBufferSource()
this.Br=z
z.buffer=$.of().t(0,b)
this.Br.connect(this.UY.destination,0,0)
z=this.Br
z.toString
...
if(c!=null){z=$.of()
z.toString
z=H.VM(new P.i5(z),[H.Kp(z,0)]).Fb.x4(c)}else z=!1
if(z)P.dT(P.k5(0,0,0,400,0,0),new M.tA(this,c))}},
uP:function(a,b){return this.R8(a,b,null)},
Hi:function(a){var z,y,x
try{this.UY=new (window.AudioContext||window.webkitAudioContext)()
this.yv()}catch(y){x=H.Ru(y)
z=x
P.JS(z)}},
static:{"^":"di,GT",Or:function(a){var z=new M.Of(null,null,null,a,0)
z.Hi(a)
return z}}},
Xp:{
"^":"Tp:20;a",
call$2:function(a,b){this.a.vj(a,b)}},
Wg:{
"^":"Tp:12;a,b,c",
call$1:function(a){var z=this.a
J.Pc(z.UY,W.DA(this.c.response)).ml(new M.la(z,this.b))}},
la:{
"^":"Tp:21;d,e",
call$1:function(a){var z,y
if(a==null)throw H.b(P.FM("Audio: Failed to decode buffer "+H.d(this.e)))
$.of().to(this.e,new M.C4(a))
z=this.d
y=z.DB+1
z.DB=y
if(y===4){P.JS("Audio: Loaded "+(y+1)+" buffers")
z.h9()}}},
C4:{
"^":"Tp:10;f",
...
DB:{
"^":"Tp:12;",
call$1:function(a){throw H.b(P.FM("Audio: Failes to send XHR!"))}},
tA:{
"^":"Tp:10;a,b",
call$0:function(){return this.a.uP(0,this.b)}},
SI:{
"^":"Tp:10;",
call$0:function(){return W.d9(null,null)}},
GX:{
"^":"Tp:10;",
call$0:function(){return W.d9(null,null)}},
eh:{
...
pu:{
"^":"Tp:10;",
call$0:function(){var z=$.ES
if(typeof z!=="number")return z.g()
return M.cn(0,0,288,512,"repeat-x",z+288,512)}},
c4:{
"^":"Tp:10;",
call$0:function(){var z=$.ES
if(typeof z!=="number")return z.g()
return M.cn(292,0,288,512,"repeat-x",z+288,512)}},
ai:{
"^":"Tp:10;",
call$0:function(){var z=$.ES
if(typeof z!=="number")return z.g()
return M.cn(584,0,336,112,"repeat-x",z+336,112)}},
o2:{
"^":"Tp:10;",
call$0:function(){return M.cn(6,982,34,24,null,null,null)}},
Nh:{
"^":"Tp:10;",
call$0:function(){return M.cn(62,982,34,24,null,null,null)}},
BK:{
"^":"Tp:10;",
call$0:function(){return M.cn(118,982,34,24,null,null,null)}},
cA:{
"^":"Tp:10;",
call$0:function(){return M.cn(174,982,34,24,null,null,null)}},
Ld:{
"^":"Tp:10;",
call$0:function(){return M.cn(230,658,34,24,null,null,null)}},
Ba:{
"^":"Tp:10;",
call$0:function(){return M.cn(230,710,34,24,null,null,null)}},
puw:{
"^":"Tp:10;",
call$0:function(){return M.cn(230,762,34,24,null,null,null)}},
c4u:{
"^":"Tp:10;",
call$0:function(){return M.cn(230,814,34,24,null,null,null)}},
ai4:{
"^":"Tp:10;",
call$0:function(){return M.cn(230,866,34,24,null,null,null)}},
o2q:{
"^":"Tp:10;",
call$0:function(){return M.cn(112,646,52,320,null,null,null)}},
Nhu:{
"^":"Tp:10;",
call$0:function(){return M.cn(168,646,52,320,null,null,null)}},
BKu:{
"^":"Tp:10;",
call$0:function(){return M.cn(112,646,52,294,"repeat-y",52,$.bK)}},
cAa:{
"^":"Tp:10;",
call$0:function(){return M.cn(0,646,52,320,null,null,null)}},
Lda:{
"^":"Tp:10;",
call$0:function(){return M.cn(56,646,52,320,null,null,null)}},
Baa:{
"^":"Tp:10;",
call$0:function(){return M.cn(0,646,52,294,"repeat-y",52,$.bK)}},
fR:{
"^":"Tp:10;",
...
call$0:function(){var z=$.ES
if(typeof z!=="number")return z.V()
return z/2+this.b*208}},
pY:{
"^":"Tp:10;a",
call$0:function(){return J.WB(J.WB(this.a.b,52),156)}},
jh:{
"^":"Tp:10;a",
call$0:function(){return this.a.a}}},1],["html_common","dart:html_common",,P,{
"^":"",
...
this.bK.call$2(z,y)
for(x=Object.keys(a),x=new H.wi(x,x.length,0,null);x.G();){w=x.lo
...
C.jW=I.makeConstantList(["hit","die","point","wing"])
C.jP=new H.LP(4,{hit:"audio/sfx_hit.ogg",die:"audio/sfx_die.ogg",point:"audio/sfx_point.ogg",wing:"audio/sfx_wing.ogg"},C.jW)
C.vB=J.is.prototype
C.ol=W.Oi.prototype
$.libraries_to_load = {}
$.te="$cachedFunction"
...
I.$lazy($,"browser","fc","AM",function(){return F.EJ()})
I.$lazy($,"_browsers","cW","yA",function(){return[$.pg(),$.MJ(),$.p8(),$.Au(),$.X9()]})
I.$lazy($,"_chrome","zT","pg",function(){return new F.oO("Chrome",new F.Md(),new F.YJ())})
I.$lazy($,"_safari","Y9","MJ",function(){return new F.oO("Safari",new F.wJ(),new F.W6())})
I.$lazy($,"_opera","Lo","p8",function(){return new F.oO("Opera",new F.DO(),new F.lP())})
I.$lazy($,"_ie","Im","Au",function(){return new F.oO("IE",new F.Uf(),new F.Ra())})
I.$lazy($,"_firefox","i6","X9",function(){return new F.oO("Firefox",new F.wJY(),new F.zOQ())})
I.$lazy($,"_unknown","vL","bp",function(){return F.Kb()})
...
I.$lazy($,"_buffers","GT","of",function(){return P.L5(null,null,null,J.O,P.r2)})
I.$lazy($,"img","Fa","vM",function(){var z=document.createElement("img",null)
J.Yj(z,"img/atlas.png")
return z})
I.$lazy($,"textures","mn","LQ",function(){return P.L5(null,null,null,J.O,W.Ny)})
I.$lazy($,"pipeRange","Em","zz",function(){return $.ao*50+1})
I.$lazy($,"rnd","ju","YG",function(){return C.pr})
I.$lazy($,"backgroundColor","wX","Vy",function(){return H.VM([],[J.im])})
I.$lazy($,"splashInfo","xD","KZ",function(){return[0,0,0,0.02]})
I.$lazy($,"birdPosition","Ma","wY",function(){var z=$.ES
if(typeof z!=="number")return z.U()
return z*1/4})
I.$lazy($,"birdHeight","HE","vW",function(){var z=$.bK
if(typeof z!=="number")return z.U()
return z*1/3})
I.$lazy($,"pipes","it","wU",function(){return P.Ls(null,null,null,[P.Z0,J.O,null])})

init.functionAliases={}
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Xd",void:true,args:[J.VA]},{func:"WW",void:true,args:[W.ea]},{func:"Dp",void:true,opt:[W.ea]},,{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"ag",args:[J.O,J.O]},{func:"K0",args:[P.r2]},{func:"ZH",args:[J.im]},{func:"MG",args:[J.im,null]},];$=null
...
Gc.prototype.sMp=function(receiver,v){return receiver.imageSmoothingEnabled=v}
...
if($desc instanceof Array)$desc=$desc[1]
O6.prototype=$desc
O6.prototype.sLA=function(receiver,v){return receiver.src=v}
...
if($desc instanceof Array)$desc=$desc[1]
XR.prototype=$desc
function FD(Jg,Rn,XZ,Rv,hG,uU,AM){this.Jg=Jg
this.Rn=Rn
this.XZ=XZ
this.Rv=Rv
this.hG=hG
...
if($desc instanceof Array)$desc=$desc[1]
EK.prototype=$desc
function oO(oc,Ir,dK){this.oc=oc
this.Ir=Ir
this.dK=dK}oO.builtin$cls="oO"
if(!"name" in oO)oO.name="oO"
$desc=$collectedClasses.oO
if($desc instanceof Array)$desc=$desc[1]
oO.prototype=$desc
function KG(oc,Ir,dK){this.oc=oc
this.Ir=Ir
this.dK=dK}KG.builtin$cls="KG"
...
if($desc instanceof Array)$desc=$desc[1]
ey.prototype=$desc
function xd(m6,Q6,zx,MU,vv,OX,OB,H9,lX,zN){this.m6=m6
this.Q6=Q6
this.zx=zx
this.MU=MU
this.vv=vv
...
if($desc instanceof Array)$desc=$desc[1]
Sw.prototype=$desc
function fO(Lz,dP,qT,Dc,fD){this.Lz=Lz
this.dP=dP
this.qT=qT
this.Dc=Dc
...
if($desc instanceof Array)$desc=$desc[1]
CS.prototype=$desc
function W9(nj,zo,Nq,QZ){this.nj=nj
this.zo=zo
this.Nq=Nq
...
if($desc instanceof Array)$desc=$desc[1]
Ip.prototype=$desc
function Of(UY,Br,ic,aW,DB){this.UY=UY
this.Br=Br
this.ic=ic
this.aW=aW
this.DB=DB}Of.builtin$cls="Of"
...
if($desc instanceof Array)$desc=$desc[1]
Wg.prototype=$desc
function la(d,e){this.d=d
this.e=e}la.builtin$cls="la"
...
if($desc instanceof Array)$desc=$desc[1]
Ua.prototype=$desc
function SIM(){}SIM.builtin$cls="SIM"
if(!"name" in SIM)SIM.name="SIM"
$desc=$collectedClasses.SIM
if($desc instanceof Array)$desc=$desc[1]
SIM.prototype=$desc
function Rnx(){}Rnx.builtin$cls="Rnx"
if(!"name" in Rnx)Rnx.name="Rnx"
$desc=$collectedClasses.Rnx
if($desc instanceof Array)$desc=$desc[1]
Rnx.prototype=$desc
function vLV(){}vLV.builtin$cls="vLV"
if(!"name" in vLV)vLV.name="vLV"
$desc=$collectedClasses.vLV
if($desc instanceof Array)$desc=$desc[1]
vLV.prototype=$desc
function GXg(){}GXg.builtin$cls="GXg"
if(!"name" in GXg)GXg.name="GXg"
$desc=$collectedClasses.GXg
if($desc instanceof Array)$desc=$desc[1]
GXg.prototype=$desc
function eh2(){}eh2.builtin$cls="eh2"
if(!"name" in eh2)eh2.name="eh2"
$desc=$collectedClasses.eh2
if($desc instanceof Array)$desc=$desc[1]
eh2.prototype=$desc
function LsI(){}LsI.builtin$cls="LsI"
if(!"name" in LsI)LsI.name="LsI"
$desc=$collectedClasses.LsI
if($desc instanceof Array)$desc=$desc[1]
LsI.prototype=$desc
function Q3e(){}Q3e.builtin$cls="Q3e"
if(!"name" in Q3e)Q3e.name="Q3e"
$desc=$collectedClasses.Q3e
if($desc instanceof Array)$desc=$desc[1]
Q3e.prototype=$desc
function uRa(){}uRa.builtin$cls="uRa"
if(!"name" in uRa)uRa.name="uRa"
$desc=$collectedClasses.uRa
if($desc instanceof Array)$desc=$desc[1]
uRa.prototype=$desc
function kga(){}kga.builtin$cls="kga"
if(!"name" in kga)kga.name="kga"
$desc=$collectedClasses.kga
if($desc instanceof Array)$desc=$desc[1]
kga.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
Ba.prototype=$desc
function puw(){}puw.builtin$cls="puw"
if(!"name" in puw)puw.name="puw"
$desc=$collectedClasses.puw
if($desc instanceof Array)$desc=$desc[1]
puw.prototype=$desc
function c4u(){}c4u.builtin$cls="c4u"
if(!"name" in c4u)c4u.name="c4u"
$desc=$collectedClasses.c4u
if($desc instanceof Array)$desc=$desc[1]
c4u.prototype=$desc
function ai4(){}ai4.builtin$cls="ai4"
if(!"name" in ai4)ai4.name="ai4"
$desc=$collectedClasses.ai4
if($desc instanceof Array)$desc=$desc[1]
ai4.prototype=$desc
function o2q(){}o2q.builtin$cls="o2q"
if(!"name" in o2q)o2q.name="o2q"
$desc=$collectedClasses.o2q
if($desc instanceof Array)$desc=$desc[1]
o2q.prototype=$desc
function Nhu(){}Nhu.builtin$cls="Nhu"
if(!"name" in Nhu)Nhu.name="Nhu"
$desc=$collectedClasses.Nhu
if($desc instanceof Array)$desc=$desc[1]
Nhu.prototype=$desc
function BKu(){}BKu.builtin$cls="BKu"
if(!"name" in BKu)BKu.name="BKu"
$desc=$collectedClasses.BKu
if($desc instanceof Array)$desc=$desc[1]
BKu.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
cAa.prototype=$desc
function Lda(){}Lda.builtin$cls="Lda"
if(!"name" in Lda)Lda.name="Lda"
$desc=$collectedClasses.Lda
if($desc instanceof Array)$desc=$desc[1]
Lda.prototype=$desc
function Baa(){}Baa.builtin$cls="Baa"
if(!"name" in Baa)Baa.name="Baa"
$desc=$collectedClasses.Baa
if($desc instanceof Array)$desc=$desc[1]
Baa.prototype=$desc
...
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,ua,Az,QP,IF,n6,Ny,Kh,TK,Y5,Gc,UD,QQ,Ey,y4,d7,Um,He,HA,vH,xO,Pb,NW,rV,Wy,QF,hs,cm,S4,cv,Fs,Ty,ea,PZ,as,dU,Aa,u5,h4,M5,xG,Ax,xf,xn,Vb,QH,ST,X2,zU,wa,tb,Sg,pA,Mi,HL,Xb,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,Vm,ZY,cx,P1,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,Bn,O6,Cp,GA,HN,Ul,KK,ii,fq,i9,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,OR,BR,vw,aG,fA,Oi,UM,hq,WS,r0,yp,c1,JU,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,y5,nV,ui,D6,DQ,Sm,dx,es,jw,lv,pf,NV,Tx,zo,wf,TC,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,EI,MI,Ub,bM,eW,Qy,Fu,OE,N9,BA,d0,tp,rE,zw,PQ,uz,Yd,U0,AD,Gr,tc,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,f1,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,cu,Wv,vR,j8,Ja,zI,cB,uY,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,r2,j4,WK,p2,vN,xl,XN,Dc,Gn,Sl,Jo,Qm,D8,ET,df,Hg,K8,xj,dE,Zc,aH,Pq,LN,cD,eo,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,In,w6,Iy,JM,o1,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,ys,LP,WT,hY,XR,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,Qx,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,vZ,VR,EK,oO,KG,ix,qd,UE,C5,Md,YJ,wJ,W6,DO,lP,Uf,Ra,wJY,zOQ,pI,NG,BV,aL,wi,i1,xy,MH,A8,SU,Ca,Z5,D0,Pf,Zf,mJ,vs,da,xw,dm,rH,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,ey,xd,v6,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,fO,CL,iP,Hn,Zl,pl,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,EH,AC,Z0,c8,a,mE,CC,wv,zL,ec,e0,RO,Cq,xC,CS,W9,e9,wA,XY,mg,LZ,XU,Ob,GV,Pg,fj,Ip,Of,Xp,Wg,la,C4,DB,tA,SI,GX,eh,Q3,kg,Ua,SIM,Rnx,vLV,GXg,eh2,LsI,Q3e,uRa,kga,Uaa,S0,S1,pu,c4,ai,o2,Nh,BK,cA,Ld,Ba,puw,c4u,ai4,o2q,Nhu,BKu,cAa,Lda,Baa,fR,ap,pY,jh,a9,YL,KC,xL,nl]}